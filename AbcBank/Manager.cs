...
namespace AbcBank
{
    public class Manager
    {
        ...
        // Customer can have more than one account of any type?
        //      If "yes", then e.g. 11 accounts would have "singlr" form
        //          TODO this would also require having unique ID/Account number
        //      else - can go back to just number == 1
