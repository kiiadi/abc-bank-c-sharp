...
namespace AbcBank
{
    ...
    {
        private const string AmountIsNotPositiveMessage = "Amount entered {0}, but it must be positive";
        ...
        public void Deposit(double amount)
        {
            if (amount <= 0)
            {
                String message = String.Format(Account.AmountIsNotPositiveMessage, amount);
